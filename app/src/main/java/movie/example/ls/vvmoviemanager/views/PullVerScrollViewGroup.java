 ...
 * Date :  2017/6/22
 */
public class PullVerScrollViewGroup extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public PullVerScrollViewGroup(Context context) {
        this(context, null);
    }

    public PullVerScrollViewGroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PullVerScrollViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
