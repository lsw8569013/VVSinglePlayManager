...
//        if(SHOW_LOGS) Logger.v(TAG, ">> playNewVideo, videoPlayer " + videoPlayerView + ", mCurrentPlayer " + mCurrentPlayer + ", videoPlayerView " + videoPlayerView);
        ...
        if(currentPlayerIsActive){
            if(isInPlaybackState() && isAlreadyPlayingTheFile){
                ...
                /** 4. */
                startNewPlayback(currentItemMetaData, videoPlayerView, videoUrl,volumeNum);
            }
        } else {
            /** 4. */
            startNewPlayback(currentItemMetaData, videoPlayerView, videoUrl,volumeNum);
    ...
    private void startNewPlayback(MetaData currentItemMetaData, VideoPlayerView videoPlayerView, String videoUrl
        ...
        videoPlayerView.setPlayManager(this);
        ...
        stopResetReleaseClearCurrentPlayer();
        setNewViewForPlayback(currentItemMetaData, videoPlayerView);
        startPlayback(videoPlayerView, videoUrl,volumeNum);
    }
    ...
    private void startNewPlayback(MetaData currentItemMetaData, VideoPlayerView videoPlayerView, String videoUrl
        ...
        stopResetReleaseClearCurrentPlayer();
        setNewViewForPlayback(currentItemMetaData, videoPlayerView);
        startPlayback(videoPlayerView, videoUrl,1);
    }
     ...
     */
    private void startPlayback(VideoPlayerView videoPlayerView, String videoUrl,float volumeNum) {
...
//                new Start(videoPlayerView, this,volumeNum)
        ));
    }
    ...
    public void addStartMessage(VideoPlayerView videoPlayerView ) {
        mPlayerHandler.addMessage(new Start(videoPlayerView, this,volumeNum));
    }
}
