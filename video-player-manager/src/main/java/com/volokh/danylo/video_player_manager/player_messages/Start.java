...
public class Start extends PlayerMessage{
    ...
    private float volumeNum = 1.0f;

    public Start(VideoPlayerView videoPlayerView, VideoPlayerManagerCallback callback,float volumeNum) {
