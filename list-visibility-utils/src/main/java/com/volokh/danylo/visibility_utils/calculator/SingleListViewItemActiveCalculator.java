...
//            if(SHOW_LOGS) Logger.e(TAG, "topToBottomMostVisibleItem, indexOfCurrentView " + indexOfCurrentView);
...
//            if(SHOW_LOGS) Logger.e(TAG, "topToBottomMostVisibleItem, currentItemVisibilityPercents " + currentItemVisibilityPercents);
//            if(SHOW_LOGS) Logger.e(TAG, "topToBottomMostVisibleItem, mostVisibleItemVisibilityPercents " + mostVisibleItemVisibilityPercents);
//
